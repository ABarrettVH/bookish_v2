...
namespace BookishDB.Migrations
{
    ...
    [Migration("20250727112816_LoseMemberBookDataFromTables")]
    partial class LoseMemberBookDataFromTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookish_v2.Models.MemberViewModel", b =>
                {
                    ...
                    b.Property<int?>("MemberViewModelMemberID")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("MemberViewModelMemberID");
            ...
            modelBuilder.Entity("Bookish_v2.Models.BookViewModel", b =>
                {
                    b.HasOne("Bookish_v2.Models.BookViewModel", null)
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Bookish_v2.Models.MemberViewModel", b =>
                {
                    b.HasOne("Bookish_v2.Models.MemberViewModel", null)
                        .WithMany("Members")
                        .HasForeignKey("MemberViewModelMemberID");
                });
